...
ax.set_title('Number of call by Branch', fontsize= 16)
ax.set_xlabel('Call', fontsize = 12)
...
ax.legend()
ax.set_xlabel('Call Purpose', fontsize = 14,labelpad = 16)
ax.set_ylabel('Count of call', fontsize = 14,labelpad = 16)
ax.set_title('Number of Call Purpose by Branch',fontsize =20, pad =15)
...
ax.legend()
ax.set_xlabel('Hours', fontsize = 14,labelpad = 16)
ax.set_ylabel('Count of call', fontsize = 14,labelpad = 16)
ax.set_title('Incoming and Outgoing Call by hours in a day',fontsize =20, pad =16)
line = ax.lines[0]
plt.show()

plot3_name = 'Incoming & Outgoing Call by hours.png'
...
fig.set_size_inches(10,13)
ax.legend()
ax.set_xlabel('Shift', fontsize = 14,labelpad = 16)
ax.set_ylabel('Count of Sale', fontsize = 14,labelpad = 16)
ax.set_title('Number of Sale by shift',fontsize =20, pad =16)
for bar in ax.patches:
    bar_value = bar.get_height()
    text = f'{bar_value:,}'
    text_x = bar.get_x() + bar.get_width() / 2
